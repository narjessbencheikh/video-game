...
int main()
{
    ...
    SDL_Surface *ecran =NULL,*imageDeFond = NULL,*image=NULL,*image2=NULL,*image3=NULL,*image4=NULL;
    ecran=SDL_SetVideoMode(1300, 1000, 32, SDL_HWSURFACE); // Ouverture de la fenêtre
    SDL_Rect positionFond,positionim,positionim2,positionim3,positionim4;//bach yefhem les cordonnée
